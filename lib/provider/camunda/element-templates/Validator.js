...
var STRING_TYPE = 'String',
    ...
    HIDDEN_TYPE = 'Hidden',
    INPUT_OUTPUT_DEFAULT_TYPE = 'IODefault';
...
function Validator() {
  ...
  /**
   * Sets property to type to default.
   *
   * @param {PropertyDescriptor} property
   *
   * @return {String} (updated) default property type
   */
  this._setDefaultType = function(property) {
    ...
    if (bindingType === CAMUNDA_INPUT_PARAMETER_TYPE ||
      ...
      property.type = INPUT_OUTPUT_DEFAULT_TYPE;
    }
  ...
  this._validateProperty = function(property) {
    ...
    if (!type) {
      type = this._setDefaultType(property);
    }
